<footer class="footer-container">
      ...
      <div id="f-links">
        ...
        <a href="../Dashboard/dashboard.php" title="Home">Home</a>

        <a href="../CampoMinado/campoMinado.php" title="Campo Minado">Jogar</a>

        <a href="../Perfil/perfil.php" title="Perfil">Perfil</a>

        <a href="../Historico/historico.php" title="Histórico">Histórico</a>

        <a href="../Ranking/ranking.php" title="Ranking">Ranking</a>
